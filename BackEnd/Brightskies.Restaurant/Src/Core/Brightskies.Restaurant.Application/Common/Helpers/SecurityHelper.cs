...
namespace Brightskies.Restaurant.Application.Common.Helpers
{
    public static class SecurityHelper
    {
        private const string Key = "8080808080808080";

        private const string IV = "8080808080808080";
        ...
        public static string Decrypt(string cipherText)
        {
            ...
            return DecryptFromBytes(encrypted, keybytes, iv);
        }
        ...
        public static string Encrypt(string text)
        {
            ...
            var encryptedBytes = EncryptToBytes(text, keybytes, iv);
